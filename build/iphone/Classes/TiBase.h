...
// in simulator we redefine to format for SiWriterPro Developer console
...
{\
	NSString * exceptionName = [@"org.siwriterpro." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.siwriterpro";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISiWriterProNativeItemNone = -1, 
	UISiWriterProNativeItemSpinner = -2,
	UISiWriterProNativeItemProgressBar = -3,
	
	UISiWriterProNativeItemSlider = -4,
	UISiWriterProNativeItemSwitch = -5,
	UISiWriterProNativeItemMultiButton = -6,
	UISiWriterProNativeItemSegmented = -7,
	
	UISiWriterProNativeItemTextView = -8,
	UISiWriterProNativeItemTextField = -9,
	UISiWriterProNativeItemSearchBar = -10,
	
	UISiWriterProNativeItemPicker = -11,
	UISiWriterProNativeItemDatePicker = -12,
	
	UISiWriterProNativeItemInfoLight = -13,
	UISiWriterProNativeItemInfoDark = -14,
	
	UISiWriterProNativeItemDisclosure = -15,
	
	UISiWriterProNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SiWriterPro instances of
