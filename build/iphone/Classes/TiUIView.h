...
/**
 Base class for all SiWriterPro views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SiWriterPro view hierarchy (such as wrapped iOS UIViews) was touched.
