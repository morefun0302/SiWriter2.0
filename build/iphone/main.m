...
NSString * const TI_APPLICATION_VERSION = @"1.5.9.7";
NSString * const TI_APPLICATION_DESCRIPTION = @"Pro, Left hand enabled version of SiWriter: a text input, note taking app for the iPad/iPad mini, based on the one handed chording keyboard Microwriting codes as used in the CyKey and AgendA. With configurable finger pad layout and multiple productivity features.";
